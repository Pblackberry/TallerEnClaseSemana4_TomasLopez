...
namespace TallerEnClaseSemana4_TomasLopez.Controllers
{
    public class JugadorController : Controller
    {
        ...
        {
            ViewData["IdEquipo"] = new SelectList(_context.Set<Equipos>(), "IdEquipo", "IdEquipo");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdJugador,NombreJugador,Posicion,IdEquipo")] Jugador jugador)
        {
            ...
            ViewData["IdEquipo"] = new SelectList(_context.Set<Equipos>(), "IdEquipo", "IdEquipo", jugador.Equipo);
            return View(jugador);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdJugador,NombreJugador,Posicion,IdEquipo")] Jugador jugador)
        {
